...
Strips leading spaces from column names (CSV formatting quirk).
"""
...
# --- Configuration ---
GCS_BUCKET_BASE_PATH = f"gs://{os.getenv('GCS_BUCKET_NAME', 'kaizenlap-data')}/primary/extracted"
...
def load_lap_sections_from_gcs(track_name: str, race_number: int) -> pd.DataFrame:
    ...
    try:
        ...
        # These CSV files use semicolons as separators, not commas
